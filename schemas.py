...
class Appointment(BaseModel):
    ...
    preferred_date: Optional[datetime] = Field(None, description="Preferred appointment date/time")
    service: str = Field(..., description="Requested service, e.g., Cleaning, Whitening")
